...
<body>
    <!-- Header -->
<header>
    <a href="#" class="logo" onclick="scrollToTop()">Dr. Wale Akinyemi</a>
    ...
    <div class="swiper events-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide event-card">
                <img src="images/about.png" alt="Event 1" class="event-image">
            ...
            <!-- Event 2 -->
            <div class="swiper-slide event-card">
                <img src="images/wale1.jpg" alt="Event 2" class="event-image">
            ...
            <!-- Event 3 -->
            <div class="swiper-slide event-card">
                <img src="images/wale2.jpg" alt="Event 3" class="event-image">
            ...
            <!-- Event 4 -->
            <div class="swiper-slide event-card">
                <img src="images/wale3.jpg" alt="Event 4" class="event-image">
...
<section id="pillars" class="pillars-of-life">
  <div class="pillars-container">
    ...
    <div class="pillars-image">
      <img src="images/wale1.jpg" alt="Pillars of Life">
    </div>
  </div>
</section>
...
<section class="author-section">
  <div class="author-container">
    ...
    <div class="author-image">
      <img src="images/wale3.jpg" alt="Author Photo">
    </div>
...
<section id="books" class="books-section">
  ...
  <div class="swiper books-slider">
    <div class="swiper-wrapper">
      ...
      <!-- Add more book slides as needed -->
	  <!-- Book 3 -->
      <div class="swiper-slide book-card">
      ...
      <div class="swiper-slide book-card">
        ...
        <div class="book-details">
          <h3 class="book-title">Secrets of the Billionaire Within</h3>
          <div class="stars">
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star-half-alt"></i>
      ...
      <div class="swiper-slide book-card">
        ...
        <div class="book-details">
          <h3 class="book-title">The Billionire Within</h3>
          <div class="stars">
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star-half-alt"></i>
      ...
      <div class="swiper-slide book-card">
        ...
        <div class="book-details">
          <h3 class="book-title">The Experience</h3>
          <div class="stars">
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star-half-alt"></i>
      ...
      <div class="swiper-slide book-card">
        ...
        <div class="book-details">
          <h3 class="book-title">Why Do Some Dream Of Success</h3>
          <div class="stars">
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star"></i><i class="fas fa-star"></i>
            <i class="fas fa-star-half-alt"></i>
  ...
  <a href="#" class="bookstore-btn">Visit Our Bookstore</a>
</div>
