...
<div class="about-description">
    <p><strong>Dr. Wale Akinyemi</strong> is the founder and CEO of <strong>The Street Hub</strong>, a multifaceted consulting firm specializing in organizational culture design and leadership development. Based in Kenya and operating across Africa, he has helped individuals, corporates, and governments unlock their full potential and build legacies of transformation. A consultant to numerous Fortune 500 companies, the United Nations, and the Supreme Court of Kenya, he has also served as a special adviser to the Chair of Kenya’s Electoral Commission and teaches transformational leadership to the highest echelons of government at the Kenya School of Government.</p>
    
    <p>He is the founder of the <strong>Street University</strong>, created to bridge the gap between theoretical academic education and the harsh realities of the real world, with over 30,000 enrolments since its inception during COVID-19.</p>
    
    <p>A prolific author of 24 books on leadership, transformation, and mindset change, he is also the founder of <strong>African Legends Publishing</strong> – a company dedicated to telling authentic and inspiring African stories of leadership and innovation.</p>
...
<div id="eventRegisterModal" class="modal">
    <div class="modal-content">
        ...
        <p>Please enter your email address and phone number to register:</p>
        <form action="register_event.php" method="POST">
		    <label for="get-started-email">Email Address:</label>
            <input type="email" name="email" placeholder="Email Address" required />
			<label for="get-started-email">Phone Number:</label>
...
<div class="swiper-slide book-card">
  ...
  <div class="book-details">
    ...
    <p class="book-price">Ksh 1,300.00</p>
...
<div id="start-now-modal" class="start-now-modal">
  <div class="start-now-modal-content">
    ...
    <form id="start-now-form" action="start_now.php" method="POST">
	  ...
	  <label for="start-now-email">Phone Number:</label>
	  <input type="text" name="phone" placeholder="Phone Number" required />
   ...
   <footer id="footer">
    <div class="footer-container">
        ...
        <div class="footer-left">
            ...
            <p><strong>Phone:</strong> +254 702 688 446</p>
