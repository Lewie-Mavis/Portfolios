...
<section class="booking-section">
  <div class="booking-container">
    <div class="booking-header">
      <h2>Book a Session with Hellen Muthoni</h2>
      <p>
        Schedule mentorship sessions, speaking engagements, or ministry services with ease.
        Choose your preferred date, service, and time — and Hellen’s team will get back to you with confirmation.
      </p>
    </div>
    ...
    <form id="booking-form" class="booking-form" action="" method="POST" >
      ...
      <div class="form-group">
        ...
        <select id="service" name="service" required>
          ...
          <option value="mentorship">Private Mentorship</option>
      ...
      <div class="form-group">
        ...
        <textarea id="message" name="message" rows="4" placeholder="Any specific requests or details?"></textarea>
      </div>

      <button type="submit" class="booking-btn">Submit Booking Request</button>
    </form>
  </div>
</section>
...
<section class="mentorship-section">
  <div class="mentorship-overlay">
    <div class="mentorship-bg-image">
      <div class="mentorship-content">
        <h2>Private Mentorship with Hellen Muthoni</h2>
        <p>
          Are you looking to grow spiritually, develop your gifts, or receive guidance in your career, ministry, or personal life?
          <br><br>
          Hellen Muthoni offers exclusive one-on-one mentorship sessions where she shares wisdom, practical insights, and prayerful support to help you walk boldly in your calling.
          <br><br>
          Whether you're an aspiring artist, minister, or simply someone seeking purpose, these sessions are designed to uplift, empower, and inspire your journey.
        </p>
        <div class="mentorship-contact">
          <strong>To request a mentorship session:</strong><br>
          Call or WhatsApp: <a href="tel:+254799201222">+254 799 201 222</a>
        </div>
      </div>
    </div>
  </div>
