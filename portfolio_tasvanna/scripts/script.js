...
document.querySelector('.chat-btn').addEventListener('click', () => {
    window.open('https://wa.me/+254733887287', '_blank'); // WhatsApp link
});

// Universal Scroll Trigger Animation for Slide Left/Right and Slide Up
...
const newsletterForm = document.getElementById('tasvannaNewsletterForm');
if (newsletterForm) {
    newsletterForm.addEventListener('submit', function(e) {
        e.preventDefault();
        
        const emailInput = this.querySelector('.tasvanna-newsletter-input');
        const email = emailInput.value;
        const button = this.querySelector('.tasvanna-newsletter-button');
        ...
        setTimeout(() => {
            ...
            const successMessage = `
                <div class="tasvanna-newsletter-success slide-up">
                    <i class="fas fa-check-circle"></i>
                    <h3>Thank You for Subscribing!</h3>
                    <p>You've successfully joined our newsletter. Check your inbox for a confirmation email.</p>
                </div>
            `;
            ...
            const successElement = formContainer.querySelector('.tasvanna-newsletter-success');
            if (successElement) {
