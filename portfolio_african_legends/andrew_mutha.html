  ...
  <div class="author-profile-container">
    <div class="author-profile-info slide-in-right">
      ...
      <div class="author-profile-image slide-in-left">
        <img src="images/andrew3.jpeg" alt="Andrew Mutha Kabeke">
      </div>

      <!-- Author Name -->
      <h2 class="author-profile-name">About Andrew Mutha Kabeke</h2>

      <!-- Author Description -->
      <p class="author-profile-description">
        Andrew Mutha Kabeke is an accomplished business leader with over two decades of experience in banking, fintech, and payments. A strategic thinker and results-driven executive, he specializes in revenue growth, team leadership, and delivering complex projects.
      </p>
...
<section class="books-authored-section">
  <div class="books-authored-container slide-in-right">
    ...
    <div class="books-grid slide-in-right">
      <!-- Book Card -->
      <div class="book-card">
        <img src="images/andrew.jpeg" alt="Book Title" class="book-image">
        <div class="book-details">
          <h3 class="book-title">UNSILENCED</h3>
          <p class="book-description">
            A battle cry for the unheard that challenges conventions and gives voice to the marginalized.
          </p>
        </div>
      </div>
