...
<head>
  ...
  <title>African Legends Publishing | Sign Up</title>
...
<section class="login-section">
  <div class="login-container">
    <h2>Join African Legends</h2>
    <p>Preserving and promoting Africa’s greatest stories</p>

    <form class="login-form" action="signup2.php" method="post">
      ...
      <div class="form-group password-group">
        ...
        <i class="fa fa-eye toggle-password" toggle="#confirm-password"></i>
      </div>
