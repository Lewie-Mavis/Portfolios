...
<body>
  ...
  <nav>
    <ul class="nav-links">
      ...
      <li><a href="index.html?id=#about-us">About</a></li>
      <li><a href="index.html?id=#publish">Get Published</a></li>
      <li><a href="index.html?id=#authors">Authors</a></li>
      <li><a href="index.html?id=#stories">Stories</a></li>
      <li><a href="index.html?id=#contact">Contact</a></li>
    </ul>
  ...
  <div class="author-profile-container">
    <div class="author-profile-info slide-in-right">
      ...
      <div class="author-profile-image slide-in-left">
        <img src="images/peter3.jpeg" alt="Peter Ndegwa Gakinya">
      </div>

      <!-- Author Name -->
      <h2 class="author-profile-name">About Peter Ndegwa Gakinya</h2>

      <!-- Author Description -->
      <p class="author-profile-description">
        Peter Ndegwa Gakinya is an entrepreneur, thought leader, and mentor who turned failure into fuel. After over 40 failed ventures and a mountain of debt, he built a thriving business through faith, grit, and relentless personal growth. His journey is living proof that success isn’t about a smooth path—it’s about refusing to stop walking.
      </p>
...
<section class="books-authored-section">
  <div class="books-authored-container slide-in-right">
    ...
    <div class="books-grid slide-in-right">
      <!-- Book Card -->
      <div class="book-card">
        <img src="images/ndegwa.jpeg" alt="The Man Who Refused to Fail" class="book-image">
        <div class="book-details">
          <h3 class="book-title">THE MAN WHO REFUSED TO FAIL</h3>
          <p class="book-description">
            40 failures. One unshakable purpose. A testament to resilience and determination.
          </p>
        </div>
      </div>
    </div>
    ...
    <!-- Move Back Button -->
    <a href="index.html?id=#authors" class="author-profile-back-button slide-in-right">← Go Back</a>
  </div>
</section>
    ...
    <div class="footer-content">
      ...
      <div class="footer-links">
        ...
        <ul>
          ...
          <li><a href="index.html?id=#about-us"><i class="fas fa-chevron-right"></i> About</a></li>
          <li><a href="index.html?id=#authors"><i class="fas fa-chevron-right"></i> Authors</a></li>
          <li><a href="index.html?id=#publish"><i class="fas fa-chevron-right"></i> Get Published</a></li>
          <li><a href="index.html?id=#stories"><i class="fas fa-chevron-right"></i> Stories</a></li>
          <li><a href="index.html?id=#contact"><i class="fas fa-chevron-right"></i> Contact</a></li>
        </ul>
      </div>
