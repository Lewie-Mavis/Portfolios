...
<section id="about">
  ...
  <div class="about-content">
    <div class="about-photo slide-left" aria-label="Photo of Lewie Mavis">
      <img src="images/logo3.png" alt="Lewie Mavis" loading="lazy" />
    </div>
<div class="about-description slide-right">
  <p>
    <strong>Lewie Mavis Software Solutions</strong> is a dynamic IT firm dedicated to delivering cutting-edge, scalable, and user-focused software solutions. Our core strengths span cybersecurity, web and mobile development, cloud computing, data systems, and AI-driven integrations.
  </p>
  <p>
...
<section id="meet-founder-section">
  ...
  <div class="founder-content">
    ...
    <div class="founder-image slide-left">
      <img src="images/lewie.webp" alt="Lewie Mavis - Founder" />
    </div>
    ...
    <div class="founder-text slide-right">
      ...
      <p>
        Lewie Mavis is a forward-thinking Computer Scientist and the visionary behind Lewie Mavis Software Solutions. With years of experience across diverse fields of software development, he blends technical expertise with a passion for innovation. His leadership has empowered startups, businesses, and organizations to scale intelligently through modern, secure, and performance-driven digital solutions.
      </p>
      <p>
        Through strategic software design, cloud technologies, and a focus on user-centric development, Lewie is committed to transforming ideas into digital realities that make an impact.
      </p>
      <a href="https://linktr.ee/lewie_mavis" target="_blank" class="online-presence-button">Visit My Portfolio</a>
    </div>
  </div>
</section>
...
<!-- AI Drive Section -->
<section id="ai-drive-section">
  <h2 class="section-title slide-right">Introducing AI Drive Company</h2>
  <div class="ai-drive-content">
    <div class="ai-drive-text slide-left">
      <p>
        <strong class="highlight-blue">AI Drive Company</strong> is a groundbreaking subsidiary of Lewie Mavis Software Solutions Company, focused on leveraging <strong class="highlight-blue">Artificial Intelligence</strong> to build next-generation software products. From predictive analytics and automation tools to intelligent apps, AI Drive pioneers AI-powered solutions that drive business transformation.
      </p>
      <p>
        Our mission is to empower organizations with innovative, secure, and intelligent technologies that boost productivity, streamline operations, and create meaningful user experiences.
      </p>
      <a href="https://aidrive.infy.uk" class="ai-drive-button" target="_blank" role="button" aria-label="Visit AI Drive Website">
        Explore AI Drive
      </a>
    </div>
    <div class="ai-drive-image slide-right" aria-label="AI Drive Logo or Illustration">
      <img src="images/ai_drive.webp" alt="AI Drive" loading="lazy">
    </div>
  </div>
</section>
...
<section id="contact">
    ...
    <div class="contact-container slide-right">
        <form class="contact-form slide-right" action="https://formsubmit.co/35a1cf89ca99806030c7eea5dcd40f2e" method="POST">
...
<footer id="footer">
  <div class="footer-container slide-right">
    ...
    <!-- Left Section: Logo, Address, Hours, Phone, Email -->
    <div class="footer-left">
      <img src="images/logo.webp" alt="Lewie Mavis Logo" class="footer-logo" />
    ...
    <div class="footer-social">
      <a href="https://www.facebook.com/lewie.lom/" class="social-icon" target="_blank"><i class="fab fa-facebook-f"></i></a>
      <a href="https://x.com/Mavis_Lewie" class="social-icon" target="_blank"><i class="fab fa-twitter"></i></a>
      <a href="https://www.linkedin.com/in/lewie-mavis-a72855207/" class="social-icon" target="_blank"><i class="fab fa-linkedin-in"></i></a>
      <a href="https://www.instagram.com/lewie_mavis/" class="social-icon" target="_blank"><i class="fab fa-instagram"></i></a>
      <a href="https://www.youtube.com/@lewiemavis" class="social-icon" target="_blank"><i class="fab fa-youtube"></i></a>
      <a href="https://lewiemavis.wordpress.com/" class="social-icon" target="_blank"><i class="fas fa-globe"></i></a>
    </div>
