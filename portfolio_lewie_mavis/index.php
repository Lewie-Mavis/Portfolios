...
<section class="hero">
    <div class="hero-content slide-right">
        ...
        <p>IT Specialist | Software Solutions Provider | Digital Services Expert</p>
...
<section id="about">
  ...
  <div class="about-content">
    <div class="about-photo slide-left" aria-label="Photo of Lewie Mavis">
      <img src="images/logo.webp" alt="Lewie Mavis" loading="lazy" />
    </div>
...
<section id="contact">
    ...
    <div class="contact-container slide-right">
        <form class="contact-form slide-right" action="https://formsubmit.co/35a1cf89ca99806030c7eea5dcd40f2e" method="POST" target="blank">
