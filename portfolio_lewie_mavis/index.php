...
<!-- AI Drive Section -->
<section id="ai-drive" class="ai-drive-section">
  <div class="ai-drive-container">
    <div class="ai-drive-text slide-left">
      <h2 class="section-title">Introducing AI Drive Company</h2>
      <p>
      ...
      <a href="https://aidrive.infy.uk" class="btn-ai-drive" role="button" aria-label="Visit AI Drive Website" target="_blank">
        Explore AI Drive
      </a>
    </div>
